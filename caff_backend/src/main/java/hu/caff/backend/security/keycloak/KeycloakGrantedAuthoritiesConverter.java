package hu.caff.backend.security.keycloak;
...
public class KeycloakGrantedAuthoritiesConverter implements Converter<Jwt, Collection<GrantedAuthority>> {
    ...
    protected Set<String> getRealmRolesFrom(Jwt jwt) {
        ...
        @SuppressWarnings("unchecked") Collection<String> realmRoles = (Collection<String>) realmAccess.get("roles");
    ...
    protected Set<String> getClientRolesFrom(Jwt jwt, String clientId) {
        ...
        @SuppressWarnings("unchecked") Map<String, List<String>> clientAccess = (Map<String, List<String>>) resourceAccess.get(clientId);
